...
class Handler(SimpleHTTPRequestHandler):
    ...
    def handle_flights_aircraft(self, parsed: urllib.parse.ParseResult):
        ...
        try:
            st, body = fetch_url(
                ...
                extra_headers={
                    "User-Agent": "KeClima/0.8.11 (weather-pwa)",
        ...
        try:
            st, body = fetch_url(
                ...
                timeout=10,
                accept="application/json",
                extra_headers={"User-Agent": "KeClima/0.8.11 (weather-pwa)"},
            )
            if st == 200:
                j = json.loads(body.decode("utf-8", errors="replace"))
    ...
    def handle_flights_live(self, parsed: urllib.parse.ParseResult):
        ...
        extra_headers = {
            "User-Agent": "KeClima/0.8.11 (weather-pwa; opensky-proxy)",
        ...
        def try_adsb_lol_fallback():
            ...
            try:
                st, bd = fetch_url(
                    ...
                    timeout=15,
                    accept="application/json",
                    extra_headers={"User-Agent": "KeClima/0.8.11 (weather-pwa; adsb-proxy)"},
                )
                if st == 200 and bd:
