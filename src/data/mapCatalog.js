...
export const MAP_SOURCES = [
  ...
  },
  {
    ...
    provider: 'Open-Meteo',
    role: 'Temp, vento, nuvens, umidade, sensação, chuva 6h, pressão',
    note: 'Modelo global · pontos em grade no mapa (camadas: temperature, wind, clouds, humidityMap, feelsLike, precipForecast, pressureMap)',
  ...
  },
  {
    id: 'sst',
    group: 'weather',
    name: 'NASA GHRSST (MUR)',
    provider: 'NASA JPL / GIBS',
    role: 'Temperatura do Mar (SST)',
    note: 'Overlay WMS GIBS · campo contínuo MUR · melhor sobre oceanos (zoom ≤ 8 nativo)',
  ...
  },
  {
    ...
    role: 'Voos ao vivo',
    note: 'Proxy: ADSB.lol (principal) · OpenSky com fallback/cache · metadados hexdb',
